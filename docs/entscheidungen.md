...
| B13 | **Anzeigenbilder: 30 im Monat enthalten, jedes weitere 2 €, einzeln nachkaufbar** (20.09.2026) | Ein eigener Zähler, weil ein Bild ein Vielfaches eines Textlaufs kostet. Gezählt wird jede erzeugte Datei, nicht jeder Entwurf — die zweite Fassung einer Grafik ist der Normalfall. Zunächst 15, am selben Tag auf 30 angehoben. Bis zum 26.09.2026 nur im Code zitiert, hier nachgetragen |
