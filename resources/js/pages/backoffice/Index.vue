...
const spalten: Spalte<Mandant>[] = [
    ...
    { schluessel: 'kontakte', titel: 'Kontakte', klasse: 'text-right tabular-nums' },
    { schluessel: 'termine30', titel: 'Termine (30 T.)', klasse: 'text-right tabular-nums' },
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="space-y-6 p-4">
            ...
            <p class="flex items-start gap-2 rounded-md border bg-muted/40 px-4 py-3 text-sm text-muted-foreground">
                ...
                Kontaktnamen, Nachrichten und Termine erscheinen hier nicht. Für einen Blick in eine Praxis brauchen Sie deren Freigabe —
                jeder solche Zugriff steht im Protokoll, auf beiden Seiten.
            </p>
            ...
            <DataTable :spalten="spalten" :zeilen="mandanten" :suchfelder="['name', 'slug']" suchtext="Praxis">
                <template #zelle-name="{ zeile }">
                    ...
                    <Badge v-if="zeile.gesperrt" variant="destructive" class="ml-2 text-[0.65rem]">Gesperrt</Badge>
                </template>
